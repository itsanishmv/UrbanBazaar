...
function Login() {
       ...
       e.preventDefault()
        signInWithEmailAndPassword(auth, mail, password)
            .then((data) => {
                ...
                const err = error.message +" Oops ,Something went wrong ,Try again with correct Email and Password"
   ...
   return (
       <LoginContainer>
           <div>
                 <img src="https://pngimg.com/uploads/amazon/amazon_PNG4.png" alt="logo" />
           </div>
